...
async function startAccessAttack() {
    const rate = document.getElementById("accessRate").value;
    const total = document.getElementById("accessTotal").value;
    const delay = document.getElementById("accessDelay").value;
    const violation = document.getElementById("accessType").value;

    const data = await createAttack("access", {
        rate: rate,
        total: total,
        delay: delay,
        violation: violation
